...
export const faqs: FAQ[] = [
 ...
 a: 'Horse insurance premiums vary widely depending on the horse\'s value, age, breed, intended use, and the level of cover selected. Mortality-only cover for a $5,000 leisure pony might cost $150–$300/year, while comprehensive cover for a $50,000 sport horse could be $2,000–$4,000/year. The best way to find out what your cover will cost is to request a free quote through EquineInsurance.co.nz.',
 },
 {
 ...
 a: 'ACC covers the cost of medical treatment and rehabilitation for personal injuries sustained, including riding injuries. However, ACC does not cover damage to your horse, damage to third-party property, or income loss beyond certain limits. Horse owners still need liability insurance for property damage claims and may want additional personal accident cover to supplement ACC entitlements.',
 },
 {
 q: 'What is loss of use insurance for horses?',
 a: 'Loss of use insurance provides compensation if your horse becomes permanently unable to perform its intended purpose due to illness or injury — even if the horse remains alive. This is particularly relevant for competition horses, racehorses, and breeding stock. Policies typically pay 50–60% of the mortality sum insured on proof of permanent unsoundness certified by a veterinarian.',
 },
 {
 q: 'Does horse insurance cover colic surgery?',
 a: 'Most comprehensive major medical horse insurance policies include cover for colic surgery, but the terms vary between insurers. Some policies have a specific colic surgery benefit; others include it within the overall veterinary fee limit. Some older policies or budget policies may exclude colic surgery entirely. Always read the policy wording carefully and ask your broker specifically about colic cover before purchasing.',
 },
 {
 q: 'Is my horse covered while being transported in a float?',
 a: 'Your horse is covered during transport if your equine insurance policy includes transit cover. Transit cover is a specific extension that protects your horse against injury, illness, or death that occurs during transportation. This is separate from horse float insurance, which covers damage to the float itself. Check whether transit cover is included in your policy or available as an add-on.',
 },
 {
 q: 'How do I make a horse insurance claim ?',
 a: 'If you need to make a horse insurance claim, contact your insurer or broker as soon as possible — ideally before or immediately after vet treatment begins, as some insurers require pre-approval for non-emergency procedures. You will generally need to provide a completed claim form, veterinary reports and invoices, and any other supporting documentation requested. Your broker can assist you through the claims process.',
 },
 {
 q: 'Do I need separate insurance for my horse float?',
 a: 'Yes — your horse float and your horse require separate insurance. Horse float insurance covers damage to the float structure, while equine transit insurance covers your horse during travel. Some car and vehicle policies include basic float cover, but may exclude commercial use or horses above a certain value. Check your existing policies and talk to a specialist broker about getting appropriate combined cover.',
 },
 {
