...
export const metadata: Metadata = {
 ...
 description: 'Contact EquineInsurance.co.nz for a free horse insurance quote. Connect with licensed equine insurance brokers — no obligation.',
...
export default function ContactPage() {
 ...
 Fill in the form below and we will connect you with a specialist equine insurance broker within 24 hours — no obligation.
 </p>
 </div>
 </div>
