...
export const metadata: Metadata = {
  ...
  description: 'Equine insurance for every horse type in NZ — sport horses, thoroughbreds, breeding stock, and leisure horses. Find the right cover for your horse.',
