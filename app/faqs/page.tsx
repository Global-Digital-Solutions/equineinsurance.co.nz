...
export const metadata: Metadata = {
  ...
  description: 'Answers to common horse insurance questions in New Zealand — colic cover, premiums, pre-existing conditions, ACC, and more. Get expert answers from equine specialists.',
      ...
      <div className="bg-brand border-b border-brand-dark">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <p className="text-green-100 text-xl leading-relaxed max-w-2xl">
            Answers to the most common questions NZ horse owners have about equine insurance.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-brand rounded-2xl p-8 text-center">
            ...
            <p className="text-green-200 mb-6">
              Our specialist equine insurance brokers are happy to answer any questions about horse insurance in New Zealand. Contact us for a free, no-obligation chat.
            </p>
