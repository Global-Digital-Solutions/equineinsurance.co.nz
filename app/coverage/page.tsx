...
export const metadata: Metadata = {
  ...
  description: 'Explore all horse insurance coverage types in NZ — mortality, major medical, transit, liability, and loss of use. Find the right equine cover for your horse.',
    ...
    <>
      <div className="bg-brand border-b border-brand-dark">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <h1 className="text-4xl font-extrabold text-white mb-4">Horse Insurance Coverage Types in NZ</h1>
          <p className="text-green-100 text-xl leading-relaxed max-w-2xl">
            Equine insurance in New Zealand covers far more than just death. Explore all the cover types available to NZ horse owners and find what you need.
          </p>
        </div>
      </div>
