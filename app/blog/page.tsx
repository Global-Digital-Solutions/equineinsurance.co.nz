...
export const metadata: Metadata = {
 ...
 description: 'Horse insurance guides, articles, and news for horse owners. Expert advice on equine insurance, colic cover, racehorse insurance, and more.',
...
export default function BlogPage() {
 ...
 Expert guides, articles, and news about equine insurance — written for horse owners.
 </p>
 </div>
 </div>
