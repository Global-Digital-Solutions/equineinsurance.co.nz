...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!post) return {}
  return {
    title: { absolute: `${post.title} | EquineInsurance.co.nz` },
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            <article className="lg:col-span-2">
              ...
              <div className="mt-10 bg-green-50 rounded-2xl p-8 border border-green-100">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Looking for Horse Insurance?</h3>
                <p className="text-gray-600 mb-4">Find a licensed specialist broker or go direct to an insurer in NZ.</p>
