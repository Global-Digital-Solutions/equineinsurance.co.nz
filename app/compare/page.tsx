...
export const metadata: Metadata = {
 ...
 description: 'Compare horse insurance providers. See which equine insurers cover mortality, vet fees, transit, liability, and loss of use — and get free quotes.',
...
export default function ComparePage() {
 ...
 <h1 className="text-4xl font-extrabold text-white mb-4">Compare Horse Insurance Providers</h1>
 <p className="text-green-100 text-xl leading-relaxed max-w-2xl">
 horse owners have several specialist equine insurance options. Our broker network accesses multiple providers to find the right fit for your horse.
 </p>
 </div>
 </div>
 ...
 The best way to compare horse insurance is to work with a specialist broker who has access to multiple insurers. Our free service connects you with licensed equine insurance brokers who can present genuine comparative options.
 </p>
