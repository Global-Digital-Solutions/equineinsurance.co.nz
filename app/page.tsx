...
const steps = [
  ...
  { num: '2', title: 'We Match You with a Broker', desc: 'We connect you with a specialist NZ equine insurance broker who understands the unique risks of horse ownership.' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-6">
                Horse Insurance NZ — <span className="text-green-300">Compare & Save</span>
              </h1>
              <p className="text-green-100 text-xl leading-relaxed mb-8">
                Mortality cover, vet fees, transit, liability and loss of use. Get free quotes from licensed NZ equine insurance brokers — no obligation.
              </p>
      ...
      <section className="py-16 bg-brand-dark">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-green-200 text-lg mb-8">
            Connect with a specialist NZ equine insurance broker — it&apos;s free, fast, and no obligation.
          </p>
