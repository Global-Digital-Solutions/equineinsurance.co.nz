...
export const metadata: Metadata = {
  ...
  description: 'About EquineInsurance.co.nz — NZ\'s specialist equine insurance comparison and referral service. We connect horse owners with licensed NZ insurance brokers.',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <section className="mb-14">
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-4">
              New Zealand horse owners invest significant time, money, and emotional energy in their horses — but many lack adequate insurance because they do not know what they need, or have not had time to compare specialist options.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed mb-4">
          ...
          <section className="mb-14">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              EquineInsurance.co.nz is a referral service. We do not sell insurance directly or act as a financial adviser. Instead, we connect you with licensed NZ insurance brokers who are regulated under the Financial Markets Conduct Act 2013.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="bg-brand rounded-2xl p-8 text-center">
            ...
            <p className="text-green-200 mb-6">Connect with a specialist NZ equine insurance broker — it takes 2 minutes and costs nothing.</p>
